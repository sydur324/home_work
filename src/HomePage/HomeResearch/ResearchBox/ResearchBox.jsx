...
const ResearchBox = ({researce}) => {
    ...
    return (
        <div className="border p-4 cursor-pointer group">
            ...
            <div className="py-2">
                  <h2 className="py-2 font-bold text-[#04205A] group-hover:text-[#91000D] duration-300">{subTitle}</h2>
                  ...
                  <p className="py-4 text-[#04205A] group-hover:text-[#91000D] duration-300 text-sm font-medium">Date of Completion: {date}</p>
            </div>
        </div>
    );
};
